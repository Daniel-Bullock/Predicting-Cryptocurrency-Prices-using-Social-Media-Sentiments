"""Scans the Chainlink smart contract for token transfer events.
The token transfer events are stored at "LINK-transfer-state.json"
Run this program by executing
"python3 chainWatcher2.py https://mainnet.infura.io/v3/b40beb8540af492e968e6b67952443cc 1000"
which scans the latest 1000 blocks on the main fork of the ethereum mainnet.
A significant part of the code is borrowed from the advanced example found at web3.py docs:
...
if __name__ == "__main__":
    ...
    def run():
        ...
        start_block = max(state.get_last_scanned_block() - chain_reorg_safety_blocks, end_block - num_latest_blocks)  ##RR_caution
